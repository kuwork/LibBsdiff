...
struct tm *gmtime_r (time_t const * restrict, struct tm * restrict_tm); /* kalen.lee@lge.com change second parameter as restrict_tm for compiling */

/* See the POSIX:2001 specification
   <http://www.opengroup.org/susv3xsh/localtime.html>.  */
struct tm *localtime_r (time_t const * restrict, struct tm * restrict_tm); /* kalen.lee@lge.com change second parameter as restrict_tm for compiling */
#endif
